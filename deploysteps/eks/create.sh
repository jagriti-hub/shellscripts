...
CLUSTERNAME=`jq -r '.Clustername' $TEMPLATE_PATH/PATHPARAM/input.json`
REGION=`jq -r '.AWSRegion' $TEMPLATE_PATH/PATAHPARAM/$RESOURCEID/input.json`

aws cloudformation describe-stacks --stack-name ${STACK_NAME} --region $REGION | jq .Stacks[0].Outputs > ${TEMPLATE_PATH}/PATHPARAM/vpcoutput.json

python3 ${TEMPLATE_PATH}/PATHPARAM/eksreplace.py ${TEMPLATE_PATH}/PATHPARAM
eksctl create cluster -f ${TEMPLATE_PATH}/PATHPARAM/eksconfig.yaml
kubectl apply -f ${TEMPLATE_PATH}/PATHPARAM/ingresscontroller.yaml
kubectl apply -f https://github.com/kubernetes-sigs/metrics-server/releases/download/v0.3.6/components.yaml
python3 ${TEMPLATE_PATH}/PATHPARAM/vpclink.py ${TEMPLATE_PATH}/PATHPARAM